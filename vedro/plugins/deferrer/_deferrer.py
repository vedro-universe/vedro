...
from typing import Any, Callable, Deque, Dict, Optional, Tuple, Type, Union
...
class DeferrerPlugin(Plugin):
    def __init__(self, config: Optional[Type["Deferrer"]] = None, *,
                 queue: Deque[Deferrable] = _queue) -> None:
